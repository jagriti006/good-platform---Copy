...
function DeleteVolunteer(props) {
  ...
  const savedocument = async (userIdpId) => {
    ...
    const response = await userAPI().updateDisableDetail(disableid);
  ...
  return (
    ...
    >
      <div className="d-flex flex-column align-items-center justify-content-center p-4">
        <div className="row">
          <div className="col">
            <Title level={2}>Disable Volunteer</Title>
          </div>
        </div>
        <div className="row mb-4">
          <div className="col">
            <Text>You're about to disable a volunteer contact detail.</Text>
          </div>
        </div>
